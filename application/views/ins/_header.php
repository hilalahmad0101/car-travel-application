                        ...
                        <li class="active"><a href="<?php echo base_url(); ?>">Home</a></li> 
						 <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="<?php echo base_url(); ?>Businesslistings/DroppingCars/Dropping%20Cars">Dropping Cars</a></li>
                                <li><a href="<?php echo base_url(); ?>Businesslistings/TodayAvailableCars/Available%20Cars">Today Available Cars</a></li>
                                <li><a href="<?php echo base_url(); ?>Businesslistings/SelfDVehicles/Self%20Driving%20Cars">Self Driving Vehicles</a></li>
                                <li><a href="<?php echo base_url(); ?>Businesslistings/TourPackages/Tour%20Packages">Tour Packages</a></li>
                                <li><a href="<?php echo base_url(); ?>Businesslistings/PromoteVCards/visiting%20cards">Promote Visiting Cards</a></li>
                                <li><a href="<?php echo base_url(); ?>Businesslistings/OtherPostings/others">Others</a></li>
                            </ul>
                        </li> 
                    </ul>
                </div>
