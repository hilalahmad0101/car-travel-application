...
<html lang="en">
  <head>
    ...
    <title><?php echo ($profile->user_Owner_Name)?ucwords($profile->user_Owner_Name):ucwords($profile->user_Name.' '.$profile->user_Surname); ?></title>

    <meta name="og:title" content="<?php echo ($profile->user_Owner_Name)?ucwords($profile->user_Owner_Name):ucwords($profile->user_Name.' '.$profile->user_Surname); ?>" />
...
<meta name="og:image" content="<?php echo ($profile->user_Profile_Photo)?$profile->user_Profile_Photo:base_url().'assets/img/CarTravels.com.jpg'; ?>" />
