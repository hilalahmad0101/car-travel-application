	...
	<section id="banner">
        ...
        <div id="main-slider" class="flexslider">
            <ul class="slides">
              <li>
                <img src="https://www.cartravels.com/web/slides/slide1.jpg" alt="" />
              ...
              <li>
                <img src="https://www.cartravels.com/web/slides/slide2.jpg" alt="" />
                <!-- <div class="flex-caption">
              ...
              <li>
                <img src="https://www.cartravels.com/web/slides/slide3.jpg" alt="" />
                <!-- <div class="flex-caption">
                    <h3>Enjoy the Journey</h3> 
					<p>Stop worrying and enjoy the trip</p> 
