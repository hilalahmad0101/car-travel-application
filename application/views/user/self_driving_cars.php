            ...
            <div class="row" style="margin: 0px;">
              ...
              <div class="col-md-8">
                ...
                <div class="form-group">
                  ...
                  <input type="file"  class="form-control" id="sdv_images" name="sdv_images" required>
              ...
              <!-- <div class="form-group input-group" id="fareDesign">
                <span class="input-group-addon fareSelected active">
                  <p>1 Hour</p>
                  <input type="text" class="form-control" name="">
                </span>
                <span class="input-group-addon fareSelected">
                  <p>12 Hour</p>
                  <input type="text" class="form-control" name="">
                </span>
                <span class="input-group-addon fareSelected">
              ...
              <div class="form-group input-group">
                ...
                <input type="text" name="HoursFare1" class="form-control" placeholder="1 Hours Fare" required>
              </div>
              ...
              <div class="form-group input-group">
                ...
                <input type="text" name="HoursFare12" class="form-control" placeholder="12 Hours Fare" required>
              </div>
              ...
              <div class="form-group input-group">
                ...
                <input type="text" name="HoursFare24" class="form-control" placeholder="24 Hours Fare" required>
              </div>
                ...
                <div class="form-group">
                  ...
                  <input type="text" maxlength="4" minlength="4" class="form-control" name="vehicleYear" placeholder='Ex: 2005' value="" required>
...
For 12 Hours minimum 200 kms and
For 24 Hours minimum 400 kms</textarea>
...
1. Original Aadhaar Card submit
2. Original Driving Licence submit.
3. 2wheeler Deposit
4. Outstation persons Deposit cash 25000/- above 3 days booking.
5.Outstation persons desposit 3nos cheques.
6. If any damage, customer is responsible.

Must have installed our cartravels.com app and enable GPS tracking permission.</textarea>
...
$('#droppingCarsForm').on('submit', function(e){  
      ...
      // return false;
        ...
        $.ajax({  
             url:"https://cartravels.com/web_api/api/SelfDriving/postSelfDrivingVehicle", 
             method:"POST", 
              type: "POST",
