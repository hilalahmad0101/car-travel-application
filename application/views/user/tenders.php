...
<div class="col-md-9">
    <div class="thumbnail margintop30 panelmargin5 ">
      ...
      <?php echo form_open_multipart('','id="tenderForm"'); ?>
        <!-- /.box-header -->
        <div class="box-body">
            ...
            <div class="row" style="margin: 0px;">
              ...
              <div class="col-md-6">
                ...
                <div class="form-group">
                  ...
                  <input type="file"  class="form-control" id="tender_images" name="tender_images" required>
                  <?php echo form_error('tender_images','<div class="error text-danger">', '</div>'); ?>
                </div>
          ...
          <div class="card-footer">
            ...
            <div class="row"style=" margin: 0px;">
              <div class="col-md-6 col-xs-12">
                ...
                <div class="form-group">
                  <button type="submit" class="form-control btn btn-info" id="tenderButtons" name="tenderButtons" value="Save"><i class="fa fa-paper-plane-o"></i> Post</button>
                </div>
              </div>
...
$('#tenderForm').on('submit', function(e){  
      ...
      // return false;
        ...
        $("#tenderButtons").prop('disabled', 'true');
        $("#tenderButtons").html('<i class="fa fa-cog fa-spin"></i> Please wait posting...', 'true');

        // return false;


        $.ajax({  
             url:"https://cartravels.com/web_api/api/Tenders/postTender", 
             method:"POST", 
              type: "POST",
             ...
             {    
                ...
                {
                  // console.log(data);
                  $('#tenderButtons').removeAttr("disabled");
                  $("#tenderButtons").html('<i class="fa fa-paper-plane-o"></i>', 'true');
                  alert(sosMsg);
