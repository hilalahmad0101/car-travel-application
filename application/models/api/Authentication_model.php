...
class Authentication_model extends CI_Model
{
    ...
    public function checkedemail($mail, $mobile = null)
    {
        $result = $this->db->query("SELECT `uniid`, `user_name`, `user_mobile`, `user_email`, `user_password`, `user_token`, `user_status`, `mobileVerification`, `emailVerification` FROM `api_cartravel_users` where `user_email` = '$mail' AND `user_mobile` = '$mobile'");
