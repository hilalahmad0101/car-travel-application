...
class Welcome extends CI_Controller 
{
	...
	public function profile()
	{
		...
		if($this->input->get('ref') == "app" && $data['profile'] != null)
		{
			...
			redirect('https://play.app.goo.gl/?link=https://play.google.com/store/apps/details?id=cartravels.co&ddl=1&pcampaignid=web_ddl_1');
		}
