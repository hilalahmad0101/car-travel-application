...
class Enquiry extends CI_Controller
{
	...
	public function getEnquiries()
	{
		if($this->input->post())
		{
			...
			$wrArr2 = array("enq.uniid" => $uniid, "enq.enq_owner_acceptance_status" => 1);

			$enquiries = $this->Enquiry_model->listEnquiries($wrArr1);
...
$templevel=0;   
  ...
  foreach ($enquiries as $key => $val) {
	 ...
	 {
	 	$grouparr[$val->enq_user_key][$i] = $enquiries[$key];
	 }
	 else
	 {
