...
// $smd->bookie_ownerMobile;
			...
			$mail->setFrom('info@cartravels.com', 'CarTravels - Booking Configuration');
			$mail->addReplyTo('info@cartravels.com', 'CarTravels - Booking Configuration');
